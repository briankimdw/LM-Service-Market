# L & M Service Market - Setup Guide
...
4. Edit `src/config/shop.ts` only if you need to change dropdown options (categories, product types, etc.).
...
3. Add environment variables in Vercel project settings:
   ...
   - `DIRECT_URL`
   - `NEXTAUTH_SECRET`
   - `NEXTAUTH_URL` (set to your production domain, e.g. `https://lmservicemarket.com`)
