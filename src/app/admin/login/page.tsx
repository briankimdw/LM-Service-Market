...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1A3C2A] via-[#1A3C2A] to-[#0f2518] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-[#D4451A]/20 rounded-2xl mb-5 border border-[#D4451A]/30">
            <FaStore className="text-[#D4451A] text-xl" />
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl shadow-black/20 p-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 mt-2 bg-[#D4451A] hover:bg-[#B83A15] text-white font-semibold rounded-xl transition-all disabled:opacity-60 flex items-center justify-center gap-2 shadow-md shadow-[#D4451A]/25 hover:shadow-lg hover:shadow-[#D4451A]/30 text-sm"
            >
              {loading ? (
                <>
